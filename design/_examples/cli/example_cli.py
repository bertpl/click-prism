"""Base example CLI using plain Click.

A fictional project management tool with enough structure to demonstrate
tree visualization and help formatting across different Click extensions.
"""
