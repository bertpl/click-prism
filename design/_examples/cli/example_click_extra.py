"""Example CLI with click-extra integration.

Demonstrates click-extra's auto-injected flags (--config, --color/--no-color,
--show-params, --time-execution, --version) on top of Cloup's Group.
"""
