"""Example CLI with rich-click integration.

Demonstrates the two integration approaches:
- import-swap: `import rich_click as click`
- cls-based: `cls=RichGroup`

This file uses the cls-based approach for clarity.
"""
